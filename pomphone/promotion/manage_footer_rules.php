...
<table class="table table-bordered table-sm">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= number_format($r['min_amount']?? 0, 2) ?></td>
            <td><?= safe_text($r['start_date']) ?></td> 
            <td><?= safe_text($r['end_date']) ?></td>
            <td style="white-space: pre-line; max-width:200px;"><?= safe_text($r['message']) ?></td>
            <td><?= $r['image_url'] ? '<img src="'.safe_text($r['image_url']).'" style="max-width:80px;">' : '-' ?></td>
            <td>
